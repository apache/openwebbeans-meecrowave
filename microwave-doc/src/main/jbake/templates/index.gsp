  ...
  <!-- ******Header****** -->
          ...
          <section class="cards-section text-center">
              <div class="container">
                  ...
                  <div class="intro">
                      <p>Welcome to Microwave website, if you are fed up to need to adapt to a server instead of letting the server adapting to you you are on the right place!</p>
                  </div><!--//intro-->
