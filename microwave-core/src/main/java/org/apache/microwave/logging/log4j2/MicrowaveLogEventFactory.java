 ...
 * under the License.
 */
package org.apache.microwave.logging.log4j2;
...
public class MicrowaveLogEventFactory extends DefaultLogEventFactory {
    @Override
    public LogEvent createEvent(final String loggerName, final Marker marker, final String fqcn,
                                ...
                                final Throwable t) {
        return new MicrowaveLog4jLogEvent(loggerName, marker, fqcn, level, data, properties, t);
    }

    public static class MicrowaveLog4jLogEvent extends Log4jLogEvent {
        private StackTraceElement source;

        public MicrowaveLog4jLogEvent(final String loggerName, final Marker marker, final String fqcn, final Level level,
        ...
        public StackTraceElement getSource() { // this doesn't work OOTB and no config available
            ...
            for (int i = stackTrace.length - 1; i > 0; i--) {
                ...
                if (getLoggerFqcn().equals(className) && stackTrace.length > i + 1) {
                    ...
                    if (i + 3 < stackTrace.length && stackTrace[i + 2].getClassName().equals("org.apache.microwave.logging.tomcat.LogFacade")) {
